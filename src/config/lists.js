...
export const VOICES = [
  { id: 'female-american', value: 'female-american', label: 'American Female' },
  { id: 'male-american', value: 'male-american', label: 'American Male' },
  { id: 'female-british', value: 'female-british', label: 'British Female' },
  { id: 'male-british', value: 'male-british', label: 'British Male' },
];
